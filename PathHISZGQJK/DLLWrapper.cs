...
namespace PathHISZGQJK
{
    public class DLLWrapper
    {
        ...
        public object Invoke(object[] ObjArray_Parameter, Type[] TypeArray_ParameterType, ModePass[] ModePassArray_Parameter, Type Type_Return)
        {
            ...
            MethodBuilder MyMethodBuilder = MyModuleBuilder.DefineGlobalMethod("SendEmr", MethodAttributes.Public | MethodAttributes.Static, Type_Return, TypeArray_ParameterType);
            ...
            MethodInfo MyMethodInfo = MyModuleBuilder.GetMethod("SendEmr");
            try
            {
