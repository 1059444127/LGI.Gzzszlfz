...
namespace LGHISJK
{
    ...
    class cssfybjy
    {
        ...
        public static string cssfybjyhx(string Sslbx, string Ssbz, string Debug)
        {
           ...
           if (brlb == "")
            ...
            if (Debug == "1")
                log.WriteMyLog(Sslbx);
            string readxml = jb01(brlb, codetype, Ssbz, Debug);
            if (Debug == "1")
                log.WriteMyLog("返回："+readxml);
