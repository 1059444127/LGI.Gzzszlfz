...
namespace LGHISJKZGQ
{
    class xmszsyy
    {
        ...
        /// <summary>
        /// 厦门中山医院, 在服务器上装mq客户端，通过我的webservice连接,以解决客户端直连，初始化很慢的问题
        /// </summary>
           ...
           string  debug = f.ReadString(Sslbx, "debug", "");
            ...
            if (Sslbx != "")
            {
                if (Sslbx == "门诊号")
                {
                  ...
                  string   fid = "BS10008";
                  return  get_mzbrxm("", fid,putcmsg, debug,"",ref  pt);
                ...
                if (Sslbx == "住院号")
                {
                    ...
                    string fid = "BS10001";
                    return get_zybrxm(fid, putcmsg, debug,ref  pt);
                 ...
                 if (Sslbx == "发票号")
                {
                    ...
                    string brlb="门诊";
                    string lczd = "";
                    string  mzh= get_mzh(fid,putcmsg,brlb, debug,ref  pt);
                    ...
                    if (mzh.Trim() != "")
                    {
                        ...
                        putcmsg = "<ESBEntry><AccessControl><UserName></UserName><Password></Password><Fid>BS10008</Fid></AccessControl><MessageHeader><Fid>BS10008</Fid><SourceSysCode>S42</SourceSysCode><TargetSysCode>S01</TargetSysCode><MsgDate>2015-01-12 14:42:58</MsgDate></MessageHeader><MsgInfo><startNum>1</startNum><endNum>2</endNum><Msg>and Patient_Id='" + mzh.Trim() + "'</Msg></MsgInfo></ESBEntry>";
                         fid = "BS10008";
                         return get_mzbrxm(Ssbz.Trim(),fid, putcmsg, debug, lczd,ref  pt);
                    }
                    else
                    {
        ...
        //webservice
        private static string get_zybrxm(string fid, string putcmsg, string debug, ref PT_XML pt)
        {
            xmzsyyWeb.Service zsyyweb = new LGHISJKZGQ.xmzsyyWeb.Service();
            ...
            try
            {
                rtn = zsyyweb.GET_MQ(fid, putcmsg, ref  getcmsg, ref err_msg);
            }
            catch(Exception  e1)
            {
        ...
        private static string get_mzbrxm(string fph,string fid, string putcmsg, string debug, string lczd,ref PT_XML pt)
        {
        ...
        private static string get_mzh(string fid, string putcmsg, string brlb, string debug, ref PT_XML pt)
        {
            ...
            try
            {
                pt.myDictionary["医嘱项目"] = ds.Tables[0].Rows[0]["DRUG_CODE"].ToString() + "^" + ds.Tables[0].Rows[0]["DRUG_NAME"].ToString();
            }
            catch
            {
