    ...
    public class NBBLRMYY
    {
        ...
        public static string ptxml(string Sslbx, string Ssbz, string Debug)
        {
            ...
            if (Sslbx != "")
            {
                ...
                if (Sslbx == "申请单号")
                {
                    string url = f.ReadString("申请单号", "url", "");
                    LGHISJKZGQ.BLWebReference.PisServiceLJ blyy = new LGHISJKZGQ.BLWebReference.PisServiceLJ();
                    if (url.Trim() != "")
                        blyy.Url = url;
                    string sBillInfo = "";
                    string sSampleInfo = "";
                 ...
                 { MessageBox.Show("mes"+Mes); 
                    ...
                    //-------------------------------------------------------------------------------------
                        ...
                        try
                        {
                            ...
                            for (int x = 0; x < xnl.Count; x++)
                            {
                                ...
                                if (bbmc.Trim() == "")
                                    bbmc = xmlok1["COLLECTBODY"].InnerText;
                                else
                        ...
                        { if (Debug == "1") MessageBox.Show("标本XML解析错误:"+ee.Message);  }
                    ...
                    /////////////////////////////////////////////////////////////////////////////////
                        ...
                        try
                        {
                            ...
                            xml = xml + "医嘱项目=" + (char)34 +xmlok["EXAMITEMCODE"].InnerText+"^"+xmlok["EXAMITEMNAME"].InnerText+ (char)34 + " ";
                    ...
                    if (Sslbx == "条码号")
                    {
                        string url = f.ReadString("条码号", "url", "");
                        ...
                        { MessageBox.Show("提取信息异常："+ee.Message);
                            return "0"; }

                        if (Debug == "1")
                        {
                           log.WriteMyLog("mes" + Mes);
                           log.WriteMyLog("sBillInfo" + sBillInfo);
                           log.WriteMyLog("sSampleInfo" + sSampleInfo);
                        }

                        if (Mes != "")
                        {

                            MessageBox.Show("HIS返回："+Mes); return "0";
                        }
                        ...
                        { 
                            MessageBox.Show("XML解析错误:"+e2.Message); return "0"; 
                        }
                        ...
                        {  MessageBox.Show("获取标本名称错误：" + ee.Message); }
                        ...
                        {
                                MessageBox.Show("生成XML异常："+ee.Message);
                            return "0";
                        }
                    }
                    ...
                    if (Sslbx == "撤销申请单")
                    {
                        ...
                        try
                        {
                            LGHISJKZGQ.BLWebReference.PisServiceLJ nbblweb = new LGHISJKZGQ.BLWebReference.PisServiceLJ();
