...
namespace PATHZGQ_HL7
{
    class readhl7
    {
        ...
        public void adtall(string msg)
        {
                    ...
                    if (l1.IndexOf("|") > 0)
                    {
                        ...
                        if (l1.Substring(0, l1.IndexOf("|")) == "NTE")
                        {
                            ...
                            while (ii1 != 999)
                            {
                                ...
                                NTE[ii1] = l1.Substring(0, l1.IndexOf("|"));
            ...
            //MessageBox.Show(DG1[0, 1].Trim() + "/" + DG1[0, 2].Trim() + "/" + DG1[0, 3].Trim() + "/" + DG1[0, 4].Trim());
            //MessageBox.Show(DG1[1, 1].Trim() + "/" + DG1[1, 2].Trim() + "/" + DG1[1, 3].Trim() + "/" + DG1[1, 4].Trim());
            //MessageBox.Show(DG1[2, 1].Trim() + "/" + DG1[2, 2].Trim() + "/" + DG1[2, 3].Trim() + "/" + DG1[2, 4].Trim());
            //MessageBox.Show(DG1[3, 1].Trim() + "/" + DG1[3, 2].Trim() + "/" + DG1[3, 3].Trim() + "/" + DG1[3, 4].Trim());
