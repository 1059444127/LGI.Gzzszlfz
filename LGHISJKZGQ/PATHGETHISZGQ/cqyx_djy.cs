...
namespace PathHISZGQJK
{
    ...
    //                                        log.WriteMyLog(blh + "执行成功！");     ///标志改为2,因为已经审核
    ...
    //                                            log.WriteMyLog(blh + "报告回传成功！");
    //                                        }
    //                                    }
    //                                }
    //                                catch (Exception e)
    //                                {
    //                                    log.WriteMyLog(blh + "回写报告失败！" + e.ToString());
    //                                }
    //                                DelFile(xmlpath, blh + ".xml");                           ///上传成功True删除指定 对应xml文件  
    //                            }
    //                            else
    //                            {
    //                                log.WriteMyLog(blh + "xml文件为空");
    //                            }
    ...
    //                                    log.WriteMyLog(blh + "在HIS中报告删除成功！");
    //                                }
    //                            }
    //                        }
    //                        else if (hxbz == "")
