...
namespace LGHISJKZGQ.jssfyweb {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="PathologyServiceSoap", Namespace="http://tempuri.org/")]
    public partial class PathologyService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public PathologyService() {
            this.Url = global::LGHISJKZGQ.Properties.Settings.Default.PATHGETHISZGQ_jssfyweb_PathologyService;
        ...
        /// <remarks/>
        public void GetPatientInfoAsync(string xml) {
            this.GetPatientInfoAsync(xml, null);
        }
        
        /// <remarks/>
        public void GetPatientInfoAsync(string xml, object userState) {
            ...
            this.InvokeAsync("GetPatientInfo", new object[] {
                        xml}, this.GetPatientInfoOperationCompleted, userState);
        }
